...
本マニュアルは、Unity Toon Shader の最新版 **Unity Toon Shader v.0.3.0-preview** 向けに書かれています。  
...
サンプルプロジェクトを開くと、`Assets\Samples\Unity Toon Shader\0.3.0-preview\Universal render pipeline`フォルダ以下に、次のようなサンプルシーンがあります。  
...
* Legacy(Built-in)の場合：`Assets\Samples\Unity Toon Shader\0.3.0-preview\Legacy render pipeline`フォルダ  
* HDRPの場合：`Assets\Samples\Unity Toon Shader\0.3.0-preview\High definition render pipeline`フォルダ　
