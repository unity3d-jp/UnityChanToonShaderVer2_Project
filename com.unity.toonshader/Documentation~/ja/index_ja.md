# Unity Toon Shader 0.2.0-preview マニュアル
...
本マニュアルは、Unity Toon Shader の最新版 **Unity Toon Shader v.0.2.0-preview** 向けに書かれています。  
...
* Legacy(Built-in)の場合：`Assets\Samples\Unity Toon Shader\0.2.0-preview\Legacy (built-in)\Runtime`フォルダ  
* HDRPの場合：`Assets\Samples\Unity Toon Shader\0.2.0-preview\High definition render pipeline\Runtime`フォルダ　
