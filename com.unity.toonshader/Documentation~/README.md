...
To learn how to use Unity Toon Shader, see [Users' Manual](./en/UTS3_Manual_en.md).  
...
see [here](./en/UTS3_Manual_en.md#1-basic-shader-settings-menu-for-uts3).  
...
-----
Be sure to check the [manual](./en/UTS3_Manual_en.md) after installation.  
...
-----
## 【Release History】  
The release history of Unity Toon Shader is [here.](./en/HISTORY_en.md)  
