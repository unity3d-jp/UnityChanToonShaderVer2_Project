...
* for the **Built-in Render Pipeline**：`Assets/Samples/Unity Toon Shader/0.8.5-preview/Legacy render pipeline` folder. 
* for the **High definition render pipeline**：`Assets/Samples/Unity Toon Shader/0.8.5-preview/High definition render pipeline` folder.