...
# Index
- [【Important】 Note on upgrading to version 2.0.7 directly](./UTS3_Manual_en.md#important-note-on-upgrading-to-version-207-directly)
...
- [Unity Toon Shader Setting Menu：Unity Toon Shader Custom Inspector](./UTS3_Manual_en.md#uts2-setting-menuuts2-custom-inspector)
  ...
  - [2.“Basic Three Colors and Control Maps Setups” Menu](./UTS3_Manual_en.md#2-basic-three-colors-and-control-maps-setups-menu)
    ...
    - [“Shadow Control Maps” Submenu](./UTS3_Manual_en.md#shadow-control-maps-submenu)
      - [Position Maps for DoubleShadeWithFeather Shaders](./UTS3_Manual_en.md#doubleshadewithfeather-shaders)
      - [Shading Grade Map for ShadingGradeMap Shaders](./UTS3_Manual_en.md#shadinggrademap-shaders)
  - [3.“Basic Lookdevs : Shading Step and Feather Settings” Menu](./UTS3_Manual_en.md#3-basic-lookdevs--shading-step-and-feather-settings-menu)
    - [【The Basics of Using the Step/Feather Sliders】](./UTS3_Manual_en.md#the-basics-of-using-the-stepfeather-sliders)
      - [DoubleShadeWithFeather Shaders](./UTS3_Manual_en.md#doubleshadewithfeather-shaders-1)
      - [ShadingGradeMap Shaders](./UTS3_Manual_en.md#shadinggrademap-shaders-1)
    - [“System Shadows : Self Shadows Receiving” Items](./UTS3_Manual_en.md#system-shadows--self-shadows-receiving-items)
    - [“Additional Settings” Submenu](./UTS3_Manual_en.md#additional-settings-submenu)
    - [【Adjusting the different colors of point lights ：Step Offset、PointLights Hi-Cut Filter】](./UTS3_Manual_en.md#adjusting-the-different-colors-of-point-lights-step-offsetpointlights-hi-cut-filter)
  - [4.“HighColor Settings” Menu](./UTS3_Manual_en.md#4-highcolor-settings-menu)
  - [5.“RimLight Settings” Menu](./UTS3_Manual_en.md#5-rimlight-settings-menu)
  - [6.“MatCap : Texture Projection Settings” Menu](./UTS3_Manual_en.md#6-matcap--texture-projection-settings-menu)
  - [7.“AngelRing Projection Settings” Menu](./UTS3_Manual_en.md#7-angelring-projection-settings-menu)
    - [Making materials for Angel Ring.](./UTS3_Manual_en.md#making-materials-for-angel-ring)
  - [8.“Emissive : Self-luminescene Setings” Menu](./UTS3_Manual_en.md#8-emissive--self-luminescene-setings-menu)
    - [How to create a texture with alpha channel](./UTS3_Manual_en.md#how-to-create-a-texture-with-alpha-channel)
    - [Tips for setting Destination Color](./UTS3_Manual_en.md#tips-for-setting-destination-color)
  - [9.“Outline Settings” Menu](./UTS3_Manual_en.md#9-outline-settings-menu)
    - [“Advanced Outline Settings” Submenu](./UTS3_Manual_en.md#advanced-outline-settings-submenu)
    - [Adjusting the strength of outlines：Outline Sampler](./UTS3_Manual_en.md#adjusting-the-strength-of-outlinesoutline-sampler)
    - [Supplementing the inverted outlines of objects：UTS_EdgeDetection](./UTS3_Manual_en.md#supplementing-the-inverted-outlines-of-objectsuts_edgedetection)
    - [Tracing baked vertices normals ：Baked Normal for Outline](./UTS3_Manual_en.md#tracing-baked-vertices-normals-baked-normal-for-outline)
    - [Moving the outline away from the camera：Offset Outline with Camera Z-axis](./UTS3_Manual_en.md#moving-the-outline-away-from-the-cameraoffset-outline-with-camera-z-axis)
  - [10.“DX11 Phong Tessellation Settings” Menu](./UTS3_Manual_en.md#10-dx11-phong-tessellation-settings-menu)
  - [11.“LightColor Contribution to Materials” Menu](./UTS3_Manual_en.md#11-lightcolor-contribution-to-materials-menu)
  - [12.“Environmental Lighting Contributions Setups” Menu](./UTS3_Manual_en.md#12-environmental-lighting-contributions-setups-menu)
    - [Decide the light probe’s brightness ：GI Intensity](./UTS3_Manual_en.md#decide-the-light-probes-brightness-gi-intensity)
    - [Adjusting the ambient blending：Unlit Intensity](./UTS3_Manual_en.md#adjusting-the-ambient-blendingunlit-intensity)
    - [Preventing overexposure when there are multiple bright lights in a scene ：SceneLights Hi-Cut Filter](./UTS3_Manual_en.md#preventing-overexposure-when-there-are-multiple-bright-lights-in-a-scene-scenelights-hi-cut-filter)
    - [Adding Built-in Light Direction as an advanced feature](./UTS3_Manual_en.md#adding-built-in-light-direction-as-an-advanced-feature)
- [Using it for visuals（pre-render）](./UTS3_Manual_en.md#using-it-for-visualspre-render)
- [About Licensing](./UTS3_Manual_en.md#about-licensing)
- [Additional Note](./UTS3_Manual_en.md#additional-note)
  - [１．Tips: Minimizing the artifacts that appear at the edge of each color when using system shadow.](./UTS3_Manual_en.md#%EF%BC%91tips-minimizing-the-artifacts-that-appear-at-the-edge-of-each-color-when-using-system-shadow)
    - [【１：Changing the linear color space】](./UTS3_Manual_en.md#%EF%BC%91changing-the-linear-color-space)
    - [【２：Increase mesh density】](./UTS3_Manual_en.md#%EF%BC%92increase-mesh-density)
    - [【３：Make artifacts disappear by adjusting BaseColor_Step/System Shadows Level 】](./UTS3_Manual_en.md#%EF%BC%93make-artifacts-disappear-by-adjusting-basecolor_stepsystem-shadows-level-)
    - [【４：Increasing the bias of the directional light】](./UTS3_Manual_en.md#%EF%BC%94increasing-the-bias-of-the-directional-light)
  - [２．Tips: Minimizing light slips when using multiple real-time point lights](./UTS3_Manual_en.md#%EF%BC%92tips-minimizing-light-slips-when-using-multiple-real-time-point-lights)
  - [３．Solution to trouble cases sent to user support](./UTS3_Manual_en.md#%EF%BC%93solution-to-trouble-cases-sent-to-user-support)
...
<img width = "400" src="../images/CellLook.png?raw=true">
<img width = "800" src="../images/CRS03.png?raw=true">

[![](https://img.youtube.com/vi/81uGu18ixpw/0.png)](https://www.youtube.com/watch?v=81uGu18ixpw)

<img width = "800" src="../images/TPK_04.png?raw=true">
<img width = "800" src="../images/HiUni01.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_10.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_11.png?raw=true">

The level of gradation between colors can also be adjusted in Unity in real-time.  

<img width = "800" src="../images/UT2018_UTS2_SuperTips_13.png?raw=true">
...
[![](https://img.youtube.com/vi/qDAo5gqIezw/0.png)](https://www.youtube.com/watch?v=qDAo5gqIezw)
...
<img width = "480" src="../images/UTS2_Standard.png?raw=true">
...
<img width = "800" src="../images/Comp_UTS2_Shaders.png?raw=true">
...
<img width = "800" src="../images/1230-11_10.png?raw=true">

## ●The Shaders in the UnityChanToonShader/NoOutline Folder

<img width = "800" src="../images/UTS2_NoOutline.png?raw=true">
...
<img width = "600" src="../images/ToonColor_Transparent.png?raw=true">
...
<img width = "800" src="../images/CheekMaterialSetting.png?raw=true">

↑Sample setting for Blush material.  

[![](https://img.youtube.com/vi/oAzgUJxP2y4/0.png)](https://www.youtube.com/watch?v=oAzgUJxP2y4)
...
<img width = "800" src="../images/UTS2_AngelRing.png?raw=true">
...
<img width = "800" src="../images/AR_Image.png?raw=true">
...
<img width = "800" src="../images/UTS2_Tess.png?raw=true">
...
<img width = "800" src="../images/DX11Tess.png?raw=true">
...
<img width = "800" src="../images/UTS2_Helper.png?raw=true">
...
<img width = "800" src="../images/OutlineHelper.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_01_01.png?raw=true">
...
<img width = "300" src="../images/Unlit_Intensity_Comp.gif?raw=true">
...
<img width = "500" src="../images/UTS2UI_02_01.png?raw=true">
...
<img width = "600" src="../images/NormalMap01.png?raw=true">
<img width = "600" src="../images/NormalMapforMatCap.png?raw=true">

By using normal maps, you can enjoy various expressions.  

<img width = "500" src="../images/UTS2UI_02_02.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_02_03.png?raw=true">
...
<img width = "800" src="../images/0906-18_03.png?raw=true">
...
<img width = "800" src="../images/0102-22_03.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_02_04.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_03_01.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_03_02.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_03_03.png?raw=true">
...
There are other ways to eliminate noise, so please also refer to [Additionl Notes](./UTS3_Manual_en.md#%EF%BC%91tips-minimizing-the-artifacts-that-appear-at-the-edge-of-each-color-when-using-system-shadow) in this manual.  
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_rev_16.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_31.png?raw=true">
<img width = "800" src="../images/UT2018_UTS2_SuperTips_32.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_05_00.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_14.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_15.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_33.png?raw=true">

<img width = "800" src="../images/UT2018_UTS2_SuperTips_34.png?raw=true">

<img width = "800" src="../images/UT2018_UTS2_SuperTips_35.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_06_00.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_06_01.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_36.png?raw=true">
...
<img width = "800" src="../images/MatcapTips.png?raw=true">
...
<img width = "800" src="../images/MatcapMask.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_07_00.png?raw=true">
...
<img width = "500" src="../images/AngelRing.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_07_01.png?raw=true">
...
<img width = "800" src="../images/HairModel.png?raw=true">
...
<img width = "800" src="../images/Hair_UV1.png?raw=true">
...
<img width = "800" src="../images/0609-04_13.png?raw=true">

---
## 8. “Emissive : Self-luminescene Setings” Menu

<img width = "500" src="../images/UTS2UI_08_00.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_17.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_08_01.png?raw=true">
...
<img width = "800" src="../images/UT2018_UTS2_SuperTips_42.png?raw=true">
<img width = "800" src="../images/UT2018_UTS2_SuperTips_43.png?raw=true">
<img width = "800" src="../images/UT2018_UTS2_SuperTips_48.png?raw=true">
...
<img width = "800" src="../images/Emissive_Tex00.png?raw=true">
...
<img width = "800" src="../images/Emissive_Tex01.png?raw=true">
<img width = "800" src="../images/Emissive_Tex02.png?raw=true">

Then import it into Unity, and in Import Settings, set `Alpha Source` to` Input Texture Alpha` and `Alpha Is Transparency` to` ON`.  

<img width = "500" src="../images/Emissive_Tex03.png?raw=true">
...
<img width = "800" src="../images/DestColor00.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_09_01.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_09_02.png?raw=true">
...
| `Baked NormalMap for Outline` | Reads normal maps that have the vertices normal from other models baked into it as “added” when setting the inverted outlines. For more, look [below](./UTS3_Manual_en.md#tracing-baked-vertices-normals-baked-normal-for-outline). | _BakedNormal |

---
### ●Adjusting the strength of outlines：**Outline Sampler**
<img width = "800" src="../images/0906-18_01.png?raw=true">
...
<img width = "400" src="../images/UTS_EdgeDetectWindow.png?raw=true">
...
<img width = "800" src="../images/0205-11_01.png?raw=true">
...
<img width = "500" src="../images/UTS2UI_11_00.png?raw=true">
...
<img width = "800" src="../images/GI_Intensity.png?raw=true">
...
<img width = "800" src="../images/LightProbe.png?raw=true">
...
<img width = "800" src="../images/GI_IntensityOFF.png?raw=true">

**↑ GI Intensity = 0**.  

<img width = "800" src="../images/GI_IntensityON.png?raw=true">
...
<img width = "800" src="../images/0105-22_01.png?raw=true">
...
<img width = "800" src="../images/0105-22_012_eng.png?raw=true">
...
<img width = "800" src="../images/0105-22_05_eng.png?raw=true">
...
<img width = "800" src="../images/0105-22_04.png?raw=true">
...
<img width = "800" src="../images/0105-22_07.png?raw=true">
...
<img width = "800" src="../images/0105-22_08.png?raw=true">
...
<img width = "800" src="../images/0105-23_02.png?raw=true">
...
<img width = "600" src="../images/Errors_01.png?raw=true">
...
<img width = "600" src="../images/Errors_02.png?raw=true">
...
<img width = "600" src="../images/Errors_03.png?raw=true">
