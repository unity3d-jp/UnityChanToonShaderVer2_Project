...
Shader "Toon (Built-in)" {
    Properties {
        ...
        // Syntesized Textures
        [HideInInspector] _MainTexSynthesized("_MainTexSynthesized",2D) = "clear" {}
        [HideInInspector] _ShadowControlSynthesized("_ShadowControlSynthesized", 2D) = "clear" {}
        [HideInInspector] _HighColor_TexSynthesized("_HighColor_TexSynthesized", 2D) = "clear" {}
        [HideInInspector] _MatCap_SamplerSynthesized("_MatCap_SamplerSynthesized", 2D) = "clear" {}
        [HideInInspector] _Outline_SamplerSynthesized("_Outline_SamplerSynthesized", 2D) = "clear" {}
