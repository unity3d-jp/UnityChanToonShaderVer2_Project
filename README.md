...
To learn how to use UTS2, see [Users' Manual](./Documentation~/en/UTS2_Manual_en.md).  
...
see [here](./Documentation~/en/UTS2_Manual_en.md#1-basic-shader-settings-menu-for-uts2).  
